        ...
        <div class="panel">
            <div class="main">
                <li class="tools-li" @click="resetScene">
                    <p class="tools-name">视角重置</p>
                </li>
                <li class="tools-li" @click="autoRotate">
                    <p class="tools-name">自动旋转</p>
                </li>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            resetScene() {
                ...
                viewer.scene.children[viewer.scene.children.findIndex(o => o.name == '树')] = tree_animate.clone()
                viewer.scene.children[viewer.scene.children.findIndex(o => o.name == 'cityv1')] = cityv1.clone()
            ...
            init() {
                ...
                lights.addDirectionalLight([30, 100, -30], {
                    color: '0xffffff',
                    intensity: 3,
                    castShadow: true,
                })
                ...
                // let light1 = new THREE.PointLight( '#fff', 2, 5 );
                // light1.add( new THREE.Mesh( sphere, new THREE.MeshBasicMaterial( { color: 0xff0040 } ) ) );
                // light1.position.set( 4, 20, 0 );
                ...
                modeloader.loadModelToScene('zuo.glb', _model => {
                    ...
                    console.log(boxx.expandByObject(_model.object))
                ...
                const curvee = new THREE.LineCurve(
                ...
                console.log(curvee)
                const points = curvee.getPoints( 4 );
                ...
                // let geometry = new THREE.BoxGeometry(55, 29, 2);
                ...
                // mesh.name = '视频'
                // mesh.position.set(4, 15, -25); //设置网格模型对象位置
                ...
                modeloader.loadModelToScene('city-v1.glb', _model => {
                    ...
                    _model.object.children.forEach((item, index) => {
                        ...
                        //     item.visible = false
                        //   }
                        //   if (item.isMesh && item.material.name === '马路') {
                        //     item.visible = true
                        //   }
                        // }
                    })
